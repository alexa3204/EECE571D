###########################################################################
## Makefile generated for component 'EECE571Asn1_Qn2'. 
## 
## Makefile     : EECE571Asn1_Qn2.mk
## Generated on : Mon Oct 20 17:33:36 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/EECE571Asn1_Qn2_acc.mexw64
...
COMPILER_COMMAND_FILE     = EECE571Asn1_Qn2_comp.rsp
CMD_FILE                  = EECE571Asn1_Qn2.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/EECE571Asn1_Qn2_acc.mexw64
...
DEFINES_STANDARD = -DMODEL=EECE571Asn1_Qn2 -DNUMST=4 -DNCSTATES=24 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/EECE571Asn1_Qn2_acc.c $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/EECE571Asn1_Qn2_acc_data.c $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = EECE571Asn1_Qn2_acc.obj EECE571Asn1_Qn2_acc_data.obj rt_nonfinite.obj c_mexapi_version.obj
...
EECE571Asn1_Qn2_acc.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/EECE571Asn1_Qn2_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


EECE571Asn1_Qn2_acc_data.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/EECE571Asn1_Qn2_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"

...
## Generated on : Mon Oct 20 17:33:35 2025
## Final product: ./EECE571Asn1_Qn2_acc.lib
...
PRODUCT = ./EECE571Asn1_Qn2_acc.lib
...
%.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn2/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

...
## Final product: ./EECE571Asn1_Qn1_acc.lib
...
PRODUCT = ./EECE571Asn1_Qn1_acc.lib
...
%.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn1/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn1/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn1/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn1/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/EECE571Asn1_Qn1/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
